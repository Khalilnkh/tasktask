...

{
    internal class Program
    {
        ...
        {
            // Task 1 and 3
            //string path = @"C:\Users\sananai\Desktop\mytest.txt";
            //try
            //{
            ...
            //    else
            //    {
            //        throw new Exception("File is not exist or Length is not bigger than 0");
            //    }
            //}
            //catch(CreateErrorException ex)
            //{
            ...
            //    else
            //    {
            //        throw new Exception("File is not exist or UserInput is not exist in array index");
            //    }
            //}catch(CreateErrorException ex)
            //{
            //    Console.WriteLine(ex.Message);
            ...
            //    else
            //    {
            //        throw new Exception("File is not exist or input line is bigger than array length");
            //    }
            //}catch(CreateErrorException ex)
            //{
            //    Console.WriteLine(ex.Message);
